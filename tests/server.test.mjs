...
test("den tredje testlandingssiden er tilgjengelig på egen URL", async () => {
  ...
  try {
    ...
    assert.match(html, /<h2>Slik virker det<\/h2>/);
    ...
    assert.match(html, /Scope, din AI-rådgiver/);
    ...
    assert.match(html, /128 ordre · 661 kr i snitt/);
    assert.match(html, /4,8 gjester per ansatt · 38 timer/);
    assert.match(html, /Personalkost/);
    assert.match(html, /12 °C · Overskyet/);
    assert.match(html, /AI-sammendrag:/);
    assert.match(html, /Netto økonomisk gevinst/);
    assert.match(html, /assets\/logos\/lightspeed\.svg/);
    assert.match(html, /assets\/logos\/tripletex\.svg/);
    assert.match(html, /assets\/logos\/tamigo\.svg/);
    assert.match(html, /Legg til restaurant/);
    assert.match(html, /Legg til integrasjon/);
    assert.match(html, /Gi tilbakemelding/);
    ...
    assert.match(stylesheet, /aspect-ratio: 20 \/ 39/);
    assert.match(stylesheet, /scroll-snap-type: x mandatory/);
    assert.match(stylesheet, /flex: 0 0 min\(88vw, 340px\)/);
