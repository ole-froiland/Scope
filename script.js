...
const revealTargets = document.querySelectorAll(".section-heading, .accounting-card, .tester-block, .footer-cta, .enkel-section-title, .enkel-panel, .enkel-step, .enkel-person, .enkel-cta-copy");
