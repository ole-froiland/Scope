...
(function () {
  ...
  async function init() {
    ...
    function setTask(task,status) {
      ...
      const target=document.querySelector('#hub-tiltak [data-task="'+task.id+'"] button')||document.querySelector('#hub-tiltak [data-filter="'+hubState.filter+'"]');target?.focus({preventScroll:true});
    }
