...
export async function createScopeServer(options = {}) {
  ...
  const server = createServer(async (request, response) => {
    ...
    try {
      ...
      if (["/clean/", "/leken/", "/enkel/", "/vakt/", "/brutal/", "/kombi/", "/netflix/", "/enkel-2/", "/kvittering/", "/meny/", "/for-etter/", "/sesong/", "/drift/", "/signal/", "/vertskap/", "/test/", "/scope/"].includes(pathname) && request.method === "GET") {
      ...
      const landingPageAliases = {
        ...
        "/enkel-2": "/landing-enkel-2.html",
        "/vakt": "/landing-vakt.html",
        "/brutal": "/landing-brutal.html",
        "/kombi": "/landing-kombi.html",
        "/netflix": "/landing-netflix.html",
        "/kvittering": "/landing-kvittering.html",
